            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                <button
                  ...
                  className={`w-full text-left px-3 py-2 rounded-full text-sm font-medium transition-all duration-300 flex items-center justify-between ${
                    rating === r.val
      ...
      <div className="flex-1">
        <div className="flex items-center justify-between mb-6">
          ...
          <select 
            ...
            className="bg-white/[0.02] border border-white/10 rounded-md text-sm px-3 py-1.5 text-white outline-none focus:border-pink-500"
          >
        ...
        {!isPending && totalPages > 1 && (
          <div className="mt-12 flex justify-center gap-2">
            <button 
              ...
              className="px-3 py-1 rounded-full border border-white/10 bg-white/5 hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
            >
              Prev
            </button>
