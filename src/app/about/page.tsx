  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden selection:bg-pink-500/30">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0 flex items-center justify-center">
        <div className="absolute top-[-20%] left-[-10%] w-[60%] h-[60%] rounded-full bg-pink-600/10 blur-[150px]" />
        <div className="absolute top-[20%] right-[-10%] w-[50%] h-[50%] rounded-full bg-purple-600/10 blur-[150px]" />
        <div className="absolute bottom-[-10%] left-[20%] w-[40%] h-[40%] rounded-full bg-rose-600/10 blur-[150px]" />
      </div>
      ...
      <main className="relative z-10 pt-32 sm:pt-40 pb-20 sm:pb-32">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-7xl md:text-8xl font-extrabold tracking-tighter mb-8 leading-[1.05] max-w-5xl mx-auto">
              ...
              <span className="relative inline-block mt-2">
                <span className="absolute -inset-2 bg-gradient-to-r from-pink-600 to-purple-600 blur-2xl opacity-40"></span>
                <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-white via-pink-200 to-rose-200">
                  human creativity.
                </span>
              </span>
            </h1>
        ...
        <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 mb-32">
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 auto-rows-[280px]">
            ...
            <motion.div 
              ...
              className="md:col-span-2 lg:col-span-2 lg:row-span-2 rounded-3xl bg-gradient-to-br from-white/[0.05] to-white/[0.01] border border-white/10 p-8 sm:p-10 relative overflow-hidden group hover:border-pink-500/30 transition-colors"
            >
              <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-pink-500/20 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3 group-hover:bg-pink-500/30 transition-colors duration-700" />
              <div className="relative z-10 h-full flex flex-col">
                <Sparkles className="w-8 h-8 text-pink-400 mb-6" />
                ...
                <div className="mt-auto">
                  <div className="inline-flex items-center gap-2 text-pink-400 font-semibold group-hover:gap-4 transition-all">
            ...
            >
              <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-purple-500/20 blur-[50px] rounded-full" />
            ...
            <motion.div 
              ...
              className="rounded-3xl bg-white/[0.02] border border-white/10 p-8 relative overflow-hidden group hover:bg-white/[0.04] transition-colors flex flex-col justify-between"
            >
              <div className="absolute -bottom-10 -left-10 w-40 h-40 bg-rose-500/20 blur-[50px] rounded-full" />
              <div className="relative z-10">
            ...
            >
              ...
              <div className="relative z-10 h-full flex flex-col justify-center">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="p-2 rounded-lg bg-purple-500/10 text-purple-400"><Cpu className="w-4 h-4" /></div>
                    <div>
            ...
            {[
              ...
              >
                <div className={`w-full sm:w-[45%] pl-12 sm:pl-0 ${item.side === 'left' ? 'sm:text-right sm:pr-8' : 'sm:text-left sm:pl-8'}`}>
                  <div className="text-pink-400 font-mono text-sm font-bold mb-2">{item.year}</div>
                  <h3 className="text-2xl font-bold mb-2 text-white">{item.title}</h3>
                  <p className="text-gray-400 text-sm leading-relaxed">{item.desc}</p>
                </div>
                
                {/* Node */}
                <div className="absolute left-0 sm:left-1/2 w-8 h-8 rounded-full bg-[#050505] border-2 border-pink-500 flex items-center justify-center sm:-translate-x-1/2 mt-1 sm:mt-0 shadow-[0_0_15px_rgba(236,72,153,0.5)]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                ...
                className="group relative rounded-3xl overflow-hidden aspect-[4/5] bg-white/[0.02] border border-white/5 shadow-lg hover:shadow-[0_0_40px_rgba(236,72,153,0.4)] hover:border-pink-500/30 transition-all duration-500"
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 z-20">
                  ...
                  <p className="text-pink-400 text-sm sm:text-base font-semibold drop-shadow-md">{member.role}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <section className="w-full max-w-5xl mx-auto px-4 sm:px-6 text-center">
          <div className="p-10 sm:p-16 rounded-[2.5rem] bg-gradient-to-b from-white/[0.05] to-transparent border border-white/10 shadow-[0_0_80px_rgba(236,72,153,0.1)] relative overflow-hidden backdrop-blur-xl">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-pink-600/20 via-transparent to-transparent pointer-events-none" />

            <div className="relative z-10">
              <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 tracking-tight">
                Shape the future of <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-rose-400 to-purple-400">writing.</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6">
                <Link href="/register" className="w-full sm:w-auto group relative">
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-pink-500 to-rose-500 rounded-full blur opacity-60 group-hover:opacity-100 transition duration-500"></div>
                  <Button size="lg" className="relative w-full sm:w-auto h-14 px-8 bg-[#050505] text-white border border-white/10 hover:bg-black/50 text-base font-bold rounded-full transition-all duration-300">
                    <Sparkles className="mr-2 w-5 h-5 text-pink-400" />
