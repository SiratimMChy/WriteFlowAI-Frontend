  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white selection:bg-pink-500/30">
      ...
      <div className="absolute top-0 inset-x-0 h-[80vh] overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute top-[20%] right-[20%] w-[40%] h-[40%] rounded-full bg-rose-600/10 blur-[100px]" />
      </div>
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 py-32 sm:py-40">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6">Privacy <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 to-rose-400">Policy</span></h1>
